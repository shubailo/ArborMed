...
class ShopShellScreen extends ConsumerWidget {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const RoomShellScreen()),
              );
            },
          ),
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                ...
                delegate: SliverChildBuilderDelegate((context, index) {
                  ...
                  final ownedItem = inventory.firstWhereOrNull(
                    (i) => i.shopItemId == item.id,
                  );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: const Color(0xFFE06C53).withValues(alpha: 0.3),
        ),
      ),
      child: Row(
