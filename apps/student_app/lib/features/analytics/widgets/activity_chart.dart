...
import '../../profile/widgets/activity_view.dart';
                ...
                children: widget.data.map((d) {
                  ...
                  if (isFuture) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.grey
                            .withValues(alpha: 0.1), // Dim disabled color
                      ...
                      decoration: BoxDecoration(
                        color: d.count > 0
                            ...
                            : Colors.grey.withValues(
                                alpha: 0.2), // Darker empty state for past days
                        borderRadius: BorderRadius.circular(4),
                        border: d.count > 0
                            ? null
                            : Border.all(
              ...
              BarChartData(
                ...
                barTouchData: BarTouchData(
                  touchTooltipData: BarTouchTooltipData(
                    getTooltipColor: (_) => CozyTheme.of(context, listen: false)
                        .surface
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        String label = activity.dayLabel ??
                            DateFormat('E').format(activity.date);
                  ...
                  return BarChartGroupData(
                    ...
                    barRods: [
                      BarChartRodData(
                        ...
                        width: widget.timeframe == ActivityTimeframe.day
                            ? 8
                        ...
                        rodStackItems: [
                          BarChartRodStackItem(
                              0,
                              d.correctCount.clamp(0, d.count).toDouble(),
                              CozyTheme.of(context, listen: false).primary),
                          BarChartRodStackItem(
                              d.correctCount.clamp(0, d.count).toDouble(),
                              d.count.toDouble(),
