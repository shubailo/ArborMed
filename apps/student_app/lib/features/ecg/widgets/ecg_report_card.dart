...
class ECGReportCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ⚡ Bolt: Pre-compute diagnosis map for O(1) lookups to avoid O(N*M) linear array scans
    final diagnosisMap = {for (var d in stats.ecgDiagnoses) d.id: d};

    final diagnosis = diagnosisMap[correctDxId] ??
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: currentCase!.secondaryDiagnosesIds.map((id) {
                      final d = diagnosisMap[id] ?? ECGDiagnosis(
                        id: id,
                        code: '?',
                        nameEn: 'Unknown',
                        nameHu: '',
