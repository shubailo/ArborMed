...
class _ContextualShopSheetState extends State<ContextualShopSheet> {
  ...
  Widget _buildDetailActions(ShopProvider provider) {
    ...
    // 💡 What: Replaced O(N) inventory scan with O(1) Set lookup for placement check
    // 🎯 Why: Reduces time complexity and redundant array iterations
    // 📊 Impact: Faster UI re-renders when interacting with item details
    // 🔬 Measurement: Reduced CPU overhead during bottom sheet state updates
