                  ...
                  children: [
                    ...
                    Expanded(
                      child: provider.isLoading
                          ...
                          : Builder(
                              builder: (context) {
                                // ⚡ Bolt: Pre-compute set of placed item IDs in O(N) before rendering list
                                // to eliminate O(N*M) loop during scrolling/building
                                final Set<int> placedItemIds = provider
                                    .inventory
                                    .where(
                                      (u) => u.isPlaced && u.itemId != null,
                                    )
                                    .map((u) => u.itemId!)
                                    .toSet();
