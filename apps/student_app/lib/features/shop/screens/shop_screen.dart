...
class _ShopScreenState extends State<ShopScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // ⚡ Bolt: O(1) Lookup Optimization
    // What: Pre-compute placed items into a Set.
    // Why: GridView.builder runs O(M) .any() scan per item, causing O(N*M) scroll stutters.
    // Impact: Reduces O(M) array scan per item to O(1) Set lookup.
    // Measurement: Smoother scrolling in the ShopScreen grid.
