...
async function seedGoldCatalog() {
    try {
        ...
        // 1. Clear existing items (be careful, but needed to restore IDs)
        // We delete user_items first to avoid FK constraints if we are resetting everything.
        // If we want to preserve user inventory, we shouldn't delete, but for MVP recovery it's safer to align.
        ...
        const items = [
            ...
            // 🪑 FURNITURE (Desks)
            { id: 200, name: 'Oak Starter Desk', type: 'furniture', slot_type: 'furniture', price: 100, asset_path: 'assets/images/furniture/desk.webp', description: 'Sturdy and reliable.', theme: 'classic' },
            { id: 201, name: 'Minimalist White', type: 'furniture', slot_type: 'furniture', price: 100, asset_path: 'assets/images/furniture/desk_1.webp', description: 'Clean lines for a clear mind.', theme: 'modern' },
            { id: 202, name: 'Mahogany Executive', type: 'furniture', slot_type: 'furniture', price: 100, asset_path: 'assets/images/furniture/desk_2.webp', description: 'Serious business.', theme: 'executive' },
            { id: 203, name: 'Gamer Station', type: 'furniture', slot_type: 'furniture', price: 100, asset_path: 'assets/images/furniture/desk_3.webp', description: 'RGB increases performance by 10%.', theme: 'gamer' },
