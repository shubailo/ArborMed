  ...
  Widget build(BuildContext context) {
    return Consumer<StatsProvider>(
      builder: (context, stats, _) {
        ...
        final List<String> defaultCorners = [
          'Anatomy',
          'Physiology',
          'Pathology',
          'Clinical',
          ...
          children: [
            ...
            Container(
              ...
              child: ListView(
                ...
                children: [
                  _buildStatRow(context, "Knowledge Level",
                      _getKnowledgeLevel(values), Icons.auto_awesome_rounded),
                  _buildStatRow(context, "Mastery Velocity", "12 pts / day",
                      Icons.speed_rounded),
                  _buildStatRow(
                      context,
                      "Focus Recommendation",
                      _getFocusRecommendation(actualCorners, values),
