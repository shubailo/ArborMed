...
class CozyTheme {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        displayMedium: GoogleFonts.figtree(
          fontSize: 24, fontWeight: FontWeight.w700, color: palette.textPrimary,
        ),
        displaySmall: GoogleFonts.figtree(
          fontSize: 20, fontWeight: FontWeight.w700, color: palette.textPrimary,
        ),
        bodyLarge: GoogleFonts.notoSans(
          fontSize: 16, fontWeight: FontWeight.w500, color: palette.textPrimary,
        ),
        bodyMedium: GoogleFonts.notoSans(
          fontSize: 14, fontWeight: FontWeight.w400, color: palette.textSecondary,
        ),
        labelLarge: GoogleFonts.figtree(
          fontSize: 16, fontWeight: FontWeight.w700, color: palette.textInverse,
          letterSpacing: 0.5,
        ),
      ),
  ...
  static InputDecoration inputDecoration(BuildContext context, String label) {
    ...
    return InputDecoration(
      ...
      filled: true,
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: palette.textSecondary.withValues(alpha: 0.2))),
      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide(color: palette.textSecondary.withValues(alpha: 0.2))),
      ...
      floatingLabelStyle: TextStyle(color: palette.primary, fontWeight: FontWeight.bold),
    );
  }
}
