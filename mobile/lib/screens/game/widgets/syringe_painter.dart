...
class SyringePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Plunger handle/rod
    canvas.drawLine(Offset(plungerX, centerY), Offset(size.width - 5, centerY),
        plungerPaint);

    // Thumb rest
    canvas.drawLine(Offset(size.width - 5, centerY - 15),
        Offset(size.width - 5, centerY + 15), plungerPaint);
    ...
    canvas.drawRect(
        Rect.fromLTWH(
            plungerX, centerY - (barrelHeight / 2) + 2, 8, barrelHeight - 4),
        stopperPaint);
    // 5. Draw Tip
    canvas.drawRect(
  ...
  void _drawParticles(Canvas canvas, double startX, double centerY,
      double liquidWidth, double barrelHeight) {
