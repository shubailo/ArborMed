            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(
                    _isStep2 ? Icons.mark_email_read_rounded : Icons.person_add_rounded, 
                    size: 60, 
                ...
                Text(
                  _isStep2 ? 'Enter the code sent to your email' : 'Start your medical journey', 
                        ...
                        children: [
                          if (!_isStep2) ...[
                            ...
                            TextFormField(
                              ...
                              decoration: CozyTheme.inputDecoration(context, '6-Digit Code'),
                              keyboardType: TextInputType.number,
                              style: TextStyle(fontSize: 24, letterSpacing: 8, fontWeight: FontWeight.bold, color: palette.textPrimary),
                              textAlign: TextAlign.center,
                              maxLength: 6,
                            ),
                          ],
                          ...
                          if (_isStep2) 
                             Padding(
                               ...
                               child: TextButton(
                                ...
                                child: Text('Change Email / Edit Details', style: TextStyle(color: palette.textSecondary)),
                                                       ),
                             ),
                        ],
                      ),
