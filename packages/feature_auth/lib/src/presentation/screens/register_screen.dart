...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _submitStep1() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        await authProvider.apiService.post('/auth/register', {
  ...
  void _submitStep2() async {
    ...
    final authProvider = Provider.of<AuthProvider>(context, listen: false);
    try {
      await authProvider.verifyRegistration(
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Verification successful! Logging in...')),
      );
  ...
  CozyPalette get palette => CozyTheme.of(context, listen: false);
