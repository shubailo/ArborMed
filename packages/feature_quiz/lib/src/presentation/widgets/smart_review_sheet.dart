...
class SmartReviewSheet extends StatelessWidget {
        ...
        children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        l10n.percentReady(readiness.overall),
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                          color: _getScoreColor(readiness.overall, palette),
          ...
          if (recommended.isEmpty)
            ...
            ...recommended.take(3).map((item) => Padding(
                  ...
                  child: _buildReviewCard(context, item, palette, l10n),
                )),
  ...
  Widget _buildReviewCard(BuildContext context, SmartReviewItem item,
      CozyPalette palette, AppLocalizations l10n) {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    l10n.retentionDaysAgo(
                        item.retention.toInt(), item.daysSince.toInt()),
                    style: TextStyle(
                      fontSize: 12,
                      color: palette.textSecondary,
                    ),
