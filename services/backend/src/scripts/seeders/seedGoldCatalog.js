  ...
  try {
    ...
    const items = [
      // 🏠 ROOMS
      {
        ...
        slot_type: 'room',
        price: 0,
        asset_path: 'assets/images/room/room_0.webp',
      ...
      },
      {
        ...
        slot_type: 'room',
        price: 500,
        asset_path: 'assets/images/room/room_1.webp',
      ...
      // 🪑 FURNITURE (Desks)
      {
        ...
        slot_type: 'desk',
        price: 100,
        asset_path: 'assets/images/furniture/desk.webp',
      ...
      },
      {
        ...
        slot_type: 'desk',
        price: 100,
        asset_path: 'assets/images/furniture/desk_1.webp',
      ...
      },
      {
        ...
        slot_type: 'desk',
        price: 100,
        asset_path: 'assets/images/furniture/desk_2.webp',
      ...
      },
      {
        ...
        slot_type: 'desk',
        price: 100,
        asset_path: 'assets/images/furniture/desk_3.webp',
      ...
      // ❄️ WALL (AC / Climate)
      {
        ...
        slot_type: 'wall_ac',
        price: 75,
        asset_path: 'assets/images/furniture/ac.webp',
      ...
      },
      {
        ...
        slot_type: 'wall_ac',
        price: 75,
        asset_path: 'assets/images/furniture/ac_1.webp',
      ...
      // 🏥 CLINICAL (Gurneys / Exam Tables)
      {
        ...
        name: 'Basic Exam Bed',
        type: 'furniture',
        slot_type: 'exam_table',
        price: 150,
        asset_path: 'assets/images/furniture/gurey_1.webp',
      ...
      },
      {
        ...
        slot_type: 'exam_table',
        price: 150,
        asset_path: 'assets/images/furniture/gurey_2.webp',
      ...
      // 🎨 DECOR (Wall)
      {
        ...
        type: 'furniture',
        slot_type: 'wall_decor',
        price: 75,
        asset_path: 'assets/images/furniture/wall_decor.webp',
      ...
      // 🪟 WINDOWS
      {
        ...
        slot_type: 'window',
        price: 200,
        asset_path: 'assets/images/furniture/window.webp',
