    ...
    return ListView(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: _buildDropdown("PR Interval", _prCategory, intervalOpts, (
                v,
              ) {
                _prCategory = v;
            ...
            Expanded(
              child: _buildDropdown("QRS Width", _qrsCategory, intervalOpts, (
                v,
              ) {
                _qrsCategory = v;
                _markInteracted("conduction");
            ...
            const SizedBox(width: 8),
            Expanded(
              child: _buildDropdown("QT Interval", _qtCategory, intervalOpts, (
                v,
              ) {
                _qtCategory = v;
                _markInteracted("conduction");
    ...
    return ListView(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: _buildDropdown("P-Wave", _pWaveMorph, pMorphs, (v) {
                _pWaveMorph = v;
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 12),
            Expanded(
              child: _buildDropdown("Bundle Branch Block", _bbb, bbbOpts, (v) {
                _bbb = v;
                _markInteracted("morphology");
              }),
            ),
        ...
        Row(
          children: [
            Expanded(
              child: _buildDropdown("ST Ischemia", _ischemia, ischemiaOpts, (
                v,
              ) {
                _ischemia = v;
                _markInteracted("morphology");
            ...
            const SizedBox(width: 12),
            Expanded(
              child: _buildDropdown("T-Wave", _tWave, tWaveOpts, (v) {
                _tWave = v;
                _markInteracted("morphology");
              }),
            ),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          if (isCorrect &&
              _currentCase?.findings != null &&
              _currentCase!.findings['management'] != null) ...[
            Builder(
              builder: (context) {
